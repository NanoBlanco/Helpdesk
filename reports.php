                        ...
                        <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="project_id" class="form-control">
                                      ...
                                      <option value="<?php echo $p['id']; ?>" 
                                                    <?php if (isset($_GET["project_id"]) && $_GET["project_id"]==$p['id']) { 
                                                        echo "selected"; 
                                                    } ?>>
                                            <?php echo $p['name']; ?>
                                      </option>
                            ...
                            <div class="col-lg-3">
                                <div class="input-group">
                                    ...
                                    <select name="priority_id" class="form-control">
                                      ...
                                      <option value="<?php echo $p['id']; ?>" 
                                            <?php if (isset($_GET["priority_id"]) && $_GET["priority_id"]==$p['id']) { 
                                                echo "selected"; 
                                            } ?>>
                                            <?php echo $p['name']; ?>
                                      </option>
                            ...
                            <div class="col-lg-3">
                                <div class="input-group">
                                  ...
                                  <input type="date" name="start_at" value="
                                    <?php if (isset($_GET["start_at"]) && $_GET["start_at"]!="") { 
                                        echo $_GET["start_at"]; 
                            ...
                            <div class="col-lg-3">
                                <div class="input-group">
                                  ...
                                  <input type="date" name="finish_at" value="
                            ...
                            <div class="col-lg-3">
                                <div class="input-group">
                                    ...
                                    <select name="status_id" class="form-control">
                                            ...
                                            <option value="<?php echo $p['id']; ?>" 
                                                <?php if (isset($_GET["status_id"]) && $_GET["status_id"]==$p['id']) { 
                                                    echo "selected"; 
                                                } ?>>
                                                <?php echo $p['name']; ?>
                                            </option>
                            ...
                            <div class="col-lg-3">
                                <div class="input-group">
                                    ...
                                    <select name="kind_id" class="form-control">
                                        ...
                                        <option value="<?php echo $p['id']; ?>" 
                                            <?php if (isset($_GET["kind_id"]) && $_GET["kind_id"]==$p['id']) { 
                                                echo "selected"; 
                                            } ?>>
                                            <?php echo $p['name']; ?>
                                        </option>
